module.exports = () => {
    ...
    const namejs = 'atSelect.js';
    const namecss = 'atSelect.css';
    const namehtml = 'atSelect.html';
    const port = 8088;
    ...
    const mainJs = '/demo.js';
    const mainScss = '/atmiraSelect.scss';
